...
public class StringEx01 {
	...
	public static void main(String[] args) {
		...
		String rNum2 = regNum.substring(regNum.indexOf("-")+1,regNum.indexOf("-")+2);
		//System.out.println(rNum2);
		String gender2 = (rNum2.equals("1")||rNum2.equals("3"))? "남":"여";
		...
		System.out.println("---------------------");
		System.out.println("숫자로 미리 변환 후 연산");
		...
		System.out.println(today-year2);
