...
public class Generics01 {
	...
	public static void main(String[] args) {
		 ...
		 * 제네릭 타입으로 구현 => 나중에 객체가 생성되어 들어올 때 타입을 확정하여 구현
		 * 
		 * 객체의 타입을 컴파일할 때 체크가 가능하며 타입의 안정성을 해치지 않는 선에서 
		 * 적당히 형변환이 가능함. 
		 * 
		...
		t.setItem(123); // 숫자로 입력을 하더라도 object
		System.out.println((int)t.getItem()+123);
