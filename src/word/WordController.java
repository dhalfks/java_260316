...
public class WordController {
	...
	public void insertWord(Scanner scan) {
		...
		while(!end.toLowerCase().equals("y")) {
			...
			System.out.println("계속입력하시겠습니까? 종료(y)>");
			end = scan.next();
		}
	...
	public void printWord() {
		...
		// class 에서 구현한 Comparable 이 작동하여 정렬
	...
	public void filePrint() throws IOException {
		...
		// String 객체의 확장 버전
		// StringBuffer 객체를 => String 으로 변환하여 저장
		
		final String FILENAME = "D:\\web_260316_omr\\memo\\word.txt";
		...
		bw.write(sb.toString()); // StringBuffer 객체를 String 객체로 변경
		bw.close();
